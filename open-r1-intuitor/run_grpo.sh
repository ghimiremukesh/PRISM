...
nohup env CUDA_VISIBLE_DEVICES=1,2,3,4,5,6,7 ACCELERATE_LOG_LEVEL=info \
    ...
    src/open_r1/grpo.py --config recipes/Qwen2.5-3B/grpo/config_demo.yaml --wandb_project open-r1 --run_name SmolLM-GRPO-DAPO > run_grpo-1.log 2>&1 &
TRAINING_PID=$!
...
# Clean up all processes | change as needed
