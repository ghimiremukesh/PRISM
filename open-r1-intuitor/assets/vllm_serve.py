...
def llm_worker(
    ...
    llm = LLM(
        ...
        trust_remote_code=script_args.trust_remote_code,  # added 
    )
...
def main(script_args: ScriptArguments):
    ...
    class GenerateResponse(BaseModel):
        ...
        prm_outputs: Optional[list] = None
    ...
    async def generate(request: GenerateRequest):
        ...
        if "logprobs" in generation_kwargs:
            # needed outputs
            needed_outputs = [output for outputs in all_outputs for output in outputs.outputs]
            return {"completion_ids": completion_ids, "prm_outputs": needed_outputs}
