...
class GRPOConfig(trl.GRPOConfig):
    ...
    include_intuitor: bool = field(
        default=False,
        metadata={"help": "Include intuitor in the training."},
    )

    prm_model: Optional[str] = field(
        default=None,
        metadata={"help": "The PRM model to use."},
    )

    prm_server_host: Optional[str] = field(
        default=None, 
        metadata={"help": "The PRM model server host."}
    )

    code_problem: Optional[bool] = field(
        default=False,
        metadata={"help": "Whether the porblem is to generate code."},
    )
...
@dataclass
class GatedGRPOScriptArguments(trl.ScriptArguments):
    """
    Script arguments for the GRPO training script.
    ...
    # supervision_interval: int = field(
    #     default=2, 
    #     metadata={"help": "Supervision interval every n steps."},
    # )
    # supervision_window: int = field(
    #     default=2, 
    #     metadata={"help": "Supervision window of k steps."},
    # )
